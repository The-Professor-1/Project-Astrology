...
SECRET_KEY = 'django-insecure-ko!nbxq^_s2&)o^4w!ya+t_)9u_25zcmdh)u3@hq26knoz$p*d'
...
#AUTH_USER_MODEL = 'createprofile.CustomUser'
MIDDLEWARE = [
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'maymer123',      # Database password
